...
class Camera(object):
    ...
    def __init__(self,width=640,height=480,fps=30):
        ...
        self.cam_intrinsics = np.loadtxt("/Users/yinmingjun/code/GRCNN_Elephant-master/real/cam_pose/camera_intrinsic.txt",delimiter=' ').reshape(3,3)
        # # Load camera pose (from running calibrate.py), intrinsics and depth scale
        self.cam_pose = np.loadtxt('/Users/yinmingjun/code/GRCNN_Elephant-master/real/camera_pose.txt', delimiter=' ')
        self.cam_depth_scale = np.loadtxt('/Users/yinmingjun/code/GRCNN_Elephant-master/real/camera_depth_scale.txt', delimiter=' ')
